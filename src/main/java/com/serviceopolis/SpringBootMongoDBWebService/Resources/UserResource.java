...
public class UserResource {
	...
	public ResponseEntity<Void> insert(@RequestBody UserDTO dtoObj) {
		User obj = service.fromDTO(dtoObj);
	...
	public ResponseEntity<Void> update(@PathVariable String id, @RequestBody UserDTO dtoObj) {
		User obj = service.fromDTO(dtoObj);
		obj.setId(id);
